...
${BLUE}             ...^^.^!~  :^ ${WHITE} ~.  .^~...-^           		${CYAN}
      ...
      ${CYAN}THC tool made for educational purpose only.
             ${ORANGE}Now in ${WHITE}- Africana-Framework
	EOF
...
{ clear; header; echo; }
	...
	cat <<- EOF
		...
		${GREEN}[${WHITE}0${GREEN}]${CYAN} Main Menu
...
attack() {
 ...
 { clear; header; echo; }
	...
	cat <<- EOF
		...
		${GREEN}[${WHITE}23${GREEN}]${CYAN} Insta Followers 2    ${GREEN}[${WHITE}47${GREEN}]${CYAN} Snapchat       ${GREEN}[${WHITE}0${GREEN}]${MAGENTA} Main Menu
...
other_sites() {
 ...
 { clear; header; echo; }
   	...
   	cat <<- EOF
		...
		${GREEN}[${WHITE}0${GREEN}]${MAGENTA} Main Menu                                         
